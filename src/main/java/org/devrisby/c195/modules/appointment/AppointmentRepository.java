...
import org.devrisby.c195.modules.contact.ContactRepository;
import org.devrisby.c195.modules.customer.CustomerRepository;
import org.devrisby.c195.modules.user.UserRepository;
...
public class AppointmentRepository implements CrudRepository<Appointment> {
    ...
    /** Retrieve all appointments by the given customer id */
    ...
    /** Find all appointments by the user id */
    ...
    /** Count total number of appointments of each contact */
