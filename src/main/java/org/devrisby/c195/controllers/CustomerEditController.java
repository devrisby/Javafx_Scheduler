...
public class CustomerEditController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        this.editButton.setOnAction(this::editCustomerAction);
        ...
        this.postalCodeTextField.setText(this.customer.getPostalCode());
        this.phoneNumberTextField.setText(this.customer.getPhone());
        this.countryComboBox.getSelectionModel().select(this.customer.getDivision().getCountry());
        this.firstLvlDivisionComboBox.getSelectionModel().select(this.customer.getDivision());
    }
    ...
    private void editCustomerAction(ActionEvent event) {
        ...
        try {
            ...
            Customer updatedCustomer = new Customer(this.customer.getCustomerID(), customerName, address, postalCode, phoneNumber, firstLvlDivision);
